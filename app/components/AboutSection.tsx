...
export default function AboutSection() {
    return (
        <section className="relative w-full bg-[#5b9acd] flex items-center justify-center px-4 sm:px-8 md:px-[110px] py-12 md:py-16 lg:py-10" data-node-id="7:17">
            {/* Content Container */}
            <div className="flex flex-col items-center gap-4 sm:gap-6 md:gap-8 w-full max-w-[1920px] mx-auto relative z-20">
                ...
                <p className="font-medium text-[clamp(16px,1.8vw,16px)] text-white leading-normal text-center max-w-[735px]" data-node-id="7:21">
