        ...
        <section className="relative w-full bg-[#ffffff] flex items-center justify-center px-4 sm:px-8 md:px-[110px] py-12 md:py-16 lg:py-20" data-node-id="7:17">
            ...
            <div className="flex flex-col items-center gap-4 sm:gap-6 md:gap-8 w-full max-w-[1920px] mx-auto relative z-20">
                <div className="flex flex-col items-center gap-2 sm:gap-3 md:gap-4 w-full">
                    <h2 className="font-bold text-[clamp(24px,3vw,24px)] gap-0 text-[#ffb703] text-center" data-node-id="7:18">
                        <span className="bg-[#ffffff] px-2 py-1" style={{ boxDecorationBreak: 'clone', WebkitBoxDecorationBreak: 'clone' }}>
                            About
                        </span>
                    </h2>
                    <h3 className="font-bold text-[clamp(32px,3.5vw,32px)] text-[#2b5374] underline leading-tight text-center underline-offset-10 decoration-solid decoration-[#ffb703]" data-node-id="7:22">
                        Our Vision
                    </h3>
                </div>
