...
export default function ChallengeSection() {
    return (
        <section className="relative w-full bg-[#345b7d] flex items-center justify-center px-4 sm:px-8 md:px-[110px] py-12 md:py-16 lg:py-20" data-node-id="8:27">
            {/* Content Container */}
            <div className="flex flex-col lg:flex-row items-center lg:items-stretch justify-center gap-6 sm:gap-8 md:gap-12 lg:gap-[6vw] w-full max-w-[1380px] mx-auto relative z-20">
                ...
                <div className="flex items-center lg:items-stretch justify-center w-full md:w-full md:max-w-full lg:w-[45vw] lg:max-w-[854px] lg:min-w-[300px] order-1 lg:order-1" data-node-id="8:41">
